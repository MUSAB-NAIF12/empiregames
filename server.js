...
if(message.content.startsWith(prefix + "hh")) {
  let randomcolor = "#RANDOM" + ((Math.random() * 0xffffff) << 0).toString(16)
let help = [``]
let helpv11 = new Discord.RichEmbed()
.setTitle('Helpful Links',
 "[Add To Your Server](https://discord.com/api/oauth2/authorize?client_id=767575997486333963&permissions=8&scope=bot)")
...
〘<:tingames:761169952853458944> ${prefix}xo ====> xo لعبة 〙**`)


message.channel.sendEmbed(helpv11)
}
});



client.login("NzY3NTc1OTk3NDg2MzMzOTYz.X4z62g.-5pxzn48wKHXbixASmCwJ6xTaLE");